        ...
        <Dropdown>
            ...
            <Dropdown.Menu placement="bottom">
                ...
                <Dropdown.Menu.GroupedList>
                    ...
                    <MenuListItemAsReactLocationLink to={`/resource/${user.ident}`}>Min
                        side</MenuListItemAsReactLocationLink>
                    <MenuListItemAsReactLocationLink to={`/user/notifications`}>Mine
                        varsler</MenuListItemAsReactLocationLink>
                </Dropdown.Menu.GroupedList>
                <AdminItems/>
            </Dropdown.Menu>
        </Dropdown>
...
function NavigationItems() {
    return (
        <Dropdown.Menu.GroupedList className="mobile-navigation">
            ...
            <MenuListItemAsReactLocationLink to="/area">
                Områder
            </MenuListItemAsReactLocationLink>
            <MenuListItemAsReactLocationLink to="/cluster">
                Klynger
            </MenuListItemAsReactLocationLink>
            <MenuListItemAsReactLocationLink to="/team">
                Team
            </MenuListItemAsReactLocationLink>
            <MenuListItemAsReactLocationLink to="/location/FA1">
                Fyrstikkalléen
            </MenuListItemAsReactLocationLink>
        </Dropdown.Menu.GroupedList>
    );
