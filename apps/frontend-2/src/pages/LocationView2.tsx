...
//TODO 04.01 ANDREAS HARNES Egen fil jeg tester ut en annen løsning på
...
const LocationView = () => {
  ...
  const [currentLocation, setCurrentLocation] = useState<LocationHierarchy>();
  ...
  //     const response = await getLocationHierarchy();
  //     if (response && parameters.locationCode) {
  //       setLocationHierarchy(response);
  //       if (locationHierarchy) {
  //         // console.log(locationHierarchy[0])
  //         const location = findSectionByCode(locationHierarchy[0], parameters.locationCode)
