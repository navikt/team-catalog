    ...
    <>
      {!loading && locationBuilding && locationStats && (
        <>
          ...
          <TeamCounter 
              teams={locationStats.locationSummaryMap[locationBuilding.code].teamCount} 
              people={locationStats.locationSummaryMap[locationBuilding.code].resourceCount} 
          />
          ...
          <Block width="100%">
            <Block width="50%" marginTop={theme.sizing.scale1200}>
              <AccordionFloors 
                ...
                section={locationSection} locationStats={locationStats?.locationSummaryMap} 
              />
            </Block>
          </Block>
